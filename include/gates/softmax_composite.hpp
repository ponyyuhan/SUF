...
inline SoftmaxCompositePrep prepare_softmax_exp(const NexpCompositeKeys& ks,
  ...
  prep.exp_job = prepare_nexp_batch(ks, k_party, std::move(hatx_public), exp_out, batch);
  return prep;
}
