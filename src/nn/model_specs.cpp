...
static const std::vector<ModelSpec> kSpecs = {
    ...
    // Paper/Table-4 guidance: BERT runs can use a tiny bitwidth (37) at φ=12.
    {"bert-base", "bert-base-uncased", "gelu", /*causal=*/false, 12, 12, 768, 3072, 512, 37, 12},
    {"bert-large", "bert-large-uncased", "gelu", /*causal=*/false, 24, 16, 1024, 4096, 512, 37, 12},
